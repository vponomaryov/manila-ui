...
class ReplicasTests(test.TestCase):
    ...
    def test_delete(self):
        ...
        self.mock_object(
            ...
            mock.Mock(return_value=[self.share_replica]))
        url = reverse(
            "horizon:project:shares:manage_replicas",
            args=[self.share.id])
    ...
    def test_promote_get(self):
        url = reverse(
            "horizon:project:shares:promote_replica",
            args=[self.share_replica.id])
    ...
    def test_promote_post_error(self):
        self.mock_object(
            api_manila,
