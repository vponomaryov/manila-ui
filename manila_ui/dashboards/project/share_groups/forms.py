...
class ThemableSelectMultipleFieldRenderer(
        forms.fields.widgets.ChoiceFieldRenderer):
    choice_input_class = forms.ThemableSelectWidget


class ThemableSelectMultiple(forms.fields.widgets.SelectMultiple):
    renderer = ThemableSelectMultipleFieldRenderer
    _empty_value = []
            ...
            for sgt in share_group_types:
                ...
                if amount_of_choices < 2:
                    ...
                    st_field = forms.MultipleChoiceField(
                        label=_("Share Types"),
                        choices=st_choices,
                        widget=ThemableSelectMultiple(attrs={
