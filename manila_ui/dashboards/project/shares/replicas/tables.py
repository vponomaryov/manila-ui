...
class PromoteReplica(tables.LinkAction):
    name = "promote_replica"
    verbose_name = _("Promote replica")
    url = "horizon:project:shares:promote_replica"
...
class ReplicasTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        table_actions = (CreateReplica, DeleteReplica)
        row_actions = (PromoteReplica, DeleteReplica)
