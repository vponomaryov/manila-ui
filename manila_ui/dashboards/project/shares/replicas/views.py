...
class PromoteReplicaView(forms.ModalFormView):
    form_class = replicas_forms.PromoteReplicaForm
    form_id = "promote_replica"
    template_name = 'project/shares/replicas/promote_replica.html'
    modal_header = _("Promote Replica")
    modal_id = "promote_replica_modal"
    submit_label = _("Promote")
    submit_url = "horizon:project:shares:promote_replica"
    success_url = 'horizon:project:shares:manage_replicas'
    page_title = _("Promote Replica")
    ...
    def get_context_data(self, **kwargs):
        context = super(PromoteReplicaView, self).get_context_data(**kwargs)
